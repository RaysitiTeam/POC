<?php
	...
	class CustomerModel extends Model 
	{
		...
		public function forgetPassword($userid, $emailaddress, $secretanswer)
		{
			...
			$sqlsecretqus = "SELECT customerid, customername, userid, secretquestion, secretanswer FROM customer WHERE emailaddress = :emailaddress AND secretanswer = :secretanswer";
